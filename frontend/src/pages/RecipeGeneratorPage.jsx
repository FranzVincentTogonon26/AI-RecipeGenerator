...
import { ChefHat, Clock, Plus, Sparkles, Users } from 'lucide-react'
...
const RecipeGeneratorPage = () => {
  ...
  const [generatedRecipe, setGeneratedRecipe] = useState(dummyGeneratedRecipe);
